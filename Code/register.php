			...
			<section class="ls section_padding_top_100 section_padding_bottom_75 columns_padding_25">
				<div class="container">
					<div class="row">
							...
							<form class="form-horizontal checkout shop-checkout" action="<?=$_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
							...
							<span class="required">*</span>
									...
									<div class="col-sm-6"> 
									<input type="text" class="form-control " name="name" id="billing_first_name" placeholder="" value="<?=isset($_POST['name'])?$_POST['name']:""?>"/>
                                        <?php if(isset($msg[0])) echo $msg[0];?> </div>
								</div>
							...
							<span class="required">*</span>
									...
									<div class="col-sm-6"> <input type="text" class="form-control " name="surname" id="billing_last_name" placeholder="" value= "<?=isset($_POST['surname'])?$_POST['surname']:""?>"/>
                                        <?php if(isset($msg[1])) echo $msg[1];?></div>
								</div>
								<div class="form-group validate-required" id="billing_last_name_field"> <label for="billing_last_name" class="col-sm-3 control-label">
							<span class="grey"><b>Password:</b></span>
							<span class="required">*</span>
						</label>
									<div class="col-sm-6"> <input type="text" class="form-control " name="pass" id="billing_last_name" placeholder="" value="<?=isset($_POST['pass'])?$_POST['pass']:""?>"/>
                                        <?=isset($msg[2])? $msg[2]:"";?> </div>
								</div>
								<div class="form-group validate-required" id="billing_company_field"> <label for="billing_company" class="col-sm-3 control-label">
							<span class="grey">Age:</span>
						</label>
